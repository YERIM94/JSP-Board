...
@WebServlet(urlPatterns = { "/MemProfile.do", "/MemLogin.do", "/login.do", "/MemJoinForm.do", "/MemModifyForm.do",
		"/MemResult.do", "/MemLoginAction.do", "/MemLogoutAction.do", "/MemberJoinAction.do", "/MemModifyFormAction.do",
		"/MemModifyAction.do", "/MemDeleteAction.do", "/MemListAction.do", "/MemListForm.do", "/AdminMemJoinForm.do",
		"/AdminMemJoinAction.do" })

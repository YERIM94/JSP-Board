 ...
 */
@WebServlet(urlPatterns= {"/BoardList.do","/BoardWrite.do","/BoardWriteFormAction.do","/BoardListAction.do","/BoardWriteAction.do"
		,"/BoardDetailForm.do","/BoardDetailAction.do"})
